...
if __name__ == "__main__":
	...
	times = [0,1,2,3,4]# 2,6,10,14,18,20
	...
	plt.plot(times , algo_unused_shared, color='orange', linestyle='dotted', marker='x' ,label='Unused_shared') #  unused shared  
	plt.plot(times , algo_unused_own, color='purple', linestyle='-', marker='+' ,label='Unused_own') # unused own 
	plt.plot(times , algo_unsatisfied_shared, color='red', linestyle='dashed', marker='v' ,label='Unsatisfied_shared') #  unused shared  'ppo_$Unused$'
	plt.plot(times , algo_unsatisfied_own, color='blue', linestyle='--', marker='D' ,label='Unsatisfied_own') # unused own 
	...
	plt.xlabel('RSU', size= 10) #'$'+pdf_plot[para]+'$'
	...
	vvv= 884
	# save file .pdf
	plt.savefig('plot/zzzz1_'+str(vvv)+'_12_20ep_multi_agent_RSU_value.pdf')  #unused
	...
	with open('model/zzzz1_'+str(vvv)+'_12_20ep_multi_agent_RSU_value.data', 'wb') as filehandle:   #unused
	...
	#plot avg of unused own + shared // unsatisfied own + shared
	plt.plot(times , max_algo_unused_shared, color='orange', linestyle='dotted', marker='x' ,label='max_Unused_shared') #  unused shared  
	plt.plot(times , max_algo_unused_own, color='purple', linestyle='-', marker='+' ,label='max_Unused_own') # unused own 
	plt.plot(times , max_algo_unsatisfied_shared, color='red', linestyle='dashed', marker='v' ,label='max_Unsatisfied_shared') #  unused shared  'ppo_$Unused$'
	plt.plot(times , max_algo_unsatisfied_own, color='blue', linestyle='--', marker='D' ,label='max_Unsatisfied_own') # unused own
	...
	plt.savefig('plot/zz1_12withonly20_20ep_max_resources_RSU_value.pdf')  #unsatisfied
	#to stock data 
	...
	with open('model/zz1_12withonly20_20ep_max_resources_RSU_value.data', 'wb') as filehandle:   #unsatisfied 
	  # store the data as binary data stream
		pickle.dump(our_file, filehandle)
